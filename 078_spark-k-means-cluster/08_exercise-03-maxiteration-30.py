...
# clusters = KMeans.train(data, K, maxIterations=1, initializationMode="random")
print ('maxiteraton = 30')
clusters = KMeans.train(data, K, maxIterations=30, initializationMode="random")
